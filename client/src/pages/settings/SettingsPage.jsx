 ...
 * PURPOSE: Implements the Settings Page screen and its page-level interactions.
...
export function resolveSettingsHomePath(from = "", user = {}) {
  if (user.role === "Admin") {
    return String(from).startsWith("/dashboard/") && !String(from).startsWith("/dashboard/invoicing/finance")
      ? from
      : "/dashboard/invoicing/admin";
  }
