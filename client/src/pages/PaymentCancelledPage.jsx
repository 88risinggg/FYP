  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f5f5f5] px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-10 text-center shadow-lg">
        ...
        <h1 className="text-2xl font-bold text-[#061e4b]">Payment Cancelled</h1>
        ...
        <div className="mt-8 space-y-3">
          {invoiceId && (
            <Link
              ...
              className="block w-full rounded-xl bg-[#ff5a52] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#e04a43]"
            >
              Try Again
            </Link>
          )}
