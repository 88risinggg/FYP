 ...
 * EVALUATION HEADER
 * FEATURE: PAYROLL - HR
 * PURPOSE: Implements the HRReports Page screen and its page-level interactions.
...
function SummaryCard({ icon: Icon, label, value, color = "coral" }) {
  const colorMap = {
    ...
    green: "from-[#2D7C83]/20 to-[#2D7C83]/10 border-emerald-500/30 text-emerald-400",
    blue: "from-[#2D7C83]/20 to-[#2D7C83]/10 border-[#2D7C83]/30 text-[#2D7C83]",
    amber: "from-[#E87562]/20 to-[#E87562]/10 border-amber-500/30 text-amber-400",
    rose: "from-[#C55245]/20 to-[#C55245]/10 border-rose-500/30 text-rose-400",
  };
    ...
    <div className="flex flex-wrap items-center gap-3">
      <div>
        ...
        <input
          ...
          className="rounded-lg border border-[#f0d2ca] bg-white/80 px-3 py-2 text-sm text-[#251E1F] outline-none focus:border-[#F38978]"
        />
      </div>
      <div>
...
function StatusBadge({ status }) {
  const colors = {
    ...
    cancelled: "bg-[#7B6660]/20 text-[#7B6660] border-[#F0D2CA]/30",
    inactive: "bg-[#7B6660]/20 text-[#7B6660] border-[#F0D2CA]/30",
  };
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium transition ${
                  isActive
                    ? "bg-[#F38978] text-white shadow-lg shadow-[#F38978]/25"
        ...
        <div className="flex flex-wrap items-end justify-between gap-4 rounded-xl border border-[#f0d2ca] bg-white/80 p-4">
          ...
          <div className="flex items-end gap-2">
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-[#F38978] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#e87562] disabled:opacity-50 disabled:cursor-not-allowed"
            >
