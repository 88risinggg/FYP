              ...
              <div className="flex items-center gap-3">
                ...
                {attachment && (
                  <button
                    ...
                    className="rounded-full p-1 text-red-300 hover:bg-red-500/20 transition"
                  >
                    <X size={16} />
                  </button>
                )}
                    ...
                    <td className="px-3 py-3">
                      {app.status === "pending" && (
                        <button
                          ...
                          className="rounded-lg border border-red-400/30 bg-red-400/10 px-3 py-1.5 text-xs font-semibold text-red-200 hover:bg-red-400/20 disabled:opacity-50 disabled:cursor-not-allowed transition"
                        >
