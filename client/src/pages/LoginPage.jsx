            ...
            >
              ...
              <form className="mt-7 space-y-5" onSubmit={handleSubmit}>
                ...
                <motion.button
                  ...
                  disabled={isLoading}
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#F4333D]/30 bg-[#F4333D]/10 px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#F4333D]/20 disabled:cursor-not-allowed disabled:opacity-50"
                  whileHover={!isLoading && !shouldReduceMotion ? { scale: 1.02 } : undefined}
                  whileTap={!isLoading && !shouldReduceMotion ? { scale: 0.98 } : undefined}
                >
                ...
                <motion.button
                  ...
                  disabled={isLoading}
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/[0.08] px-4 py-3 text-sm font-semibold text-white transition hover:bg-white/[0.14] disabled:cursor-not-allowed disabled:opacity-50"
                  whileHover={!isLoading && !shouldReduceMotion ? { scale: 1.02 } : undefined}
                  whileTap={!isLoading && !shouldReduceMotion ? { scale: 0.98 } : undefined}
                >
