...
const moduleDetails = {
  invoicing: {
    ...
    icon: FileText,
    shellClass: "border-[#f0d2ca] bg-white/95 shadow-[#F38978]/10",
    iconClass: "bg-gradient-to-br from-[#F38978] to-[#e87562] text-[#251E1F] shadow-[#F38978]/25",
    accentClass: "from-[#F38978] via-[#e87562] to-[#F38978]",
    buttonClass: "bg-[#F38978] text-[#251E1F] shadow-[#F38978]/25 hover:bg-[#e87562]"
  },
  payroll: {
    ...
    icon: WalletCards,
    shellClass: "border-[#e87562]/30 bg-white/95 shadow-[#e87562]/10",
    iconClass: "bg-gradient-to-br from-[#e87562] to-[#F38978] text-[#251E1F] shadow-[#e87562]/25",
    accentClass: "from-[#e87562] via-[#F38978] to-[#F38978]",
    buttonClass: "bg-gradient-to-r from-[#e87562] to-[#F38978] text-[#251E1F] hover:brightness-110"
  }
};
...
export default function ModuleSelectionPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#fff8f5] via-[#fff3ee] to-[#FDD9CD] px-5 py-6 text-[#251E1F] sm:px-6 lg:px-8">
      ...
      />
      <motion.div
        className="pointer-events-none absolute bottom-[-8rem] right-[-6rem] h-96 w-96 rounded-full bg-[#e87562]/20 blur-3xl"
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl flex-col">
        <header className="flex items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#ead3cc] bg-white/80 text-sm font-bold shadow-lg shadow-[#f2b5a9]/20 backdrop-blur">
              AIP
            </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-[#F38978]/25 bg-white/80 px-4 py-2 text-sm font-medium text-[#251E1F] shadow-lg shadow-[#F38978]/10 backdrop-blur transition hover:bg-[#fff3ee]"
          >
            <LogOut size={16} />
            Logout
          </button>
        ...
        <section className="flex flex-1 flex-col justify-center py-14">
          ...
          >
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#ead3cc] bg-white/80 px-4 py-2 text-sm text-[#514440] backdrop-blur">
              <Sparkles size={16} className="text-[#e87562]" />
