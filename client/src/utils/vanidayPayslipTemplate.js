...
export function normalizeVanidayPayslip(payslip = {}) {
  ...
  return {
    companyName: payslip.company_name || "PayNivo Pte. Ltd.",
...
<style>
  ...
  <header class="header"><img class="logo" src="${payNivoLogoDataUrl}" alt="PayNivo logo"><div class="heading"><div class="company">${escapeHtml(data.companyName)} - Payslip</div><div class="title">${escapeHtml(data.employeeName)} for ${escapeHtml(data.period)}</div></div></header><div class="accent"></div>
