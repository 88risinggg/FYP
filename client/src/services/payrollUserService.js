...
export const resendAccountSetup = ({ requestId, userId }) => apiRequest(
  requestId
    ? `/api/payroll/users/activation-requests/${requestId}/resend-setup`
    : `/api/payroll/users/${userId}/resend-setup`,
  { method: "POST" }
);
